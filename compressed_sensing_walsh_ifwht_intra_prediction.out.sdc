## Generated SDC file "compressed_sensing_walsh_ifwht_intra_prediction.out.sdc"
...
create_clock -name {CLK} -period 12.94 -waveform { 0.000 6.47 } [get_ports { CLK }]
